...
# In 2006 and 2014, white and native american.
```
...
```{r}
freq_table = table(us_mass_shootings_clean$WEAPONSOBTAINEDLEGALLY, us_mass_shootings_clean$GENDER
      , dnn = c('WEAPONSOBTAINEDLEGALLY', 'GENDER'))
...
```{r}
chisq = chisq.test(freq_table) # store the above in an object
