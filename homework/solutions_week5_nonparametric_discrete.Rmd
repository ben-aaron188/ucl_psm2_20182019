...
hist(data1_week5$public_disorder_rank)
hist(data1_week5$socialmedia_rank)

#assessing normality statistically
shapiro.test(data1_week5$deprivation_rank)
shapiro.test(data1_week5$public_disorder_rank)
shapiro.test(data1_week5$socialmedia_rank)

#calculating correlation
cor(data1_week5$deprivation_rank, data1_week5$public_disorder_rank, method = 'spearman')
cor(data1_week5$deprivation_rank, data1_week5$socialmedia_rank, method = 'spearman')
cor(data1_week5$public_disorder_rank, data1_week5$socialmedia_rank, method = 'spearman')
```
